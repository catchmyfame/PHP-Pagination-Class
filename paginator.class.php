...
todo:
- should calling paginate() automatically call display-pages? Nah, there may be a reason not to like being able to call the class in the head and then output it later.
- how can we jquery-ify this?
*/
error_reporting(-1);
class Paginator{
	public $current_page;
